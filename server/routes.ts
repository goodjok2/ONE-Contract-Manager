...
async function seedDefaults() {
  try {
    ...
    const homeModels = [
      ...
      { name: 'Gabriel', code: 'GABRIEL', bed: 3, bath: 2, sqft: 1484, design: 800000, offsite: 43442667, onsite: 36405090 },
      { name: 'Sierra', code: 'SIERRA', bed: 3, bath: 2, sqft: 1681, design: 800000, offsite: 47608000, onsite: 37066225 },
